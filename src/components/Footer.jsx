...
const Footer = () => {
    return (
        <div className=" w-full h-screen flex gap-5 bg-zinc-900 p-20">
            <div className="w-1/2 font-grotesk flex flex-col  h-full justify-between">
                <div className="heading"> <h1 className="text-9xl uppercase leading-none -mb-10">
                    Eye-
                </h1>
                    <h1 className="text-9xl uppercase leading-none -mb-10">Opening</h1></div>
            ...
            <div className="w-1/2">
                <h1 className="text-[9vw] font-grotesk uppercase  font-semibold">
                    Presentations
                    
                </h1>
                <div className="dets text-md font-nueue uppercase font-light flex flex-col">
                        <a href="">Facebook</a>
                        <a href="">Instagram</a>
                        <a href="">Twitter</a>
                    </div>
